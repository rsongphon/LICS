import { Container, Heading, VStack, Input, Textarea, Button, Flex } from "@chakra-ui/react"
import { createFileRoute, useNavigate, Link } from "@tanstack/react-router"
import { useMutation, useQueryClient } from "@tanstack/react-query"
import { useForm } from "react-hook-form"
import { ExperimentsService, type ExperimentCreate } from "@/client"
...
function CreateExperiment() {
    ...
    const { register, handleSubmit, formState: { errors, isSubmitting } } = useForm<ExperimentCreate>()

    const mutation = useMutation({
        mutationFn: (data: ExperimentCreate) => ExperimentsService.createExperiment({ requestBody: data }),
        onSuccess: () => {
